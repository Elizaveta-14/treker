...
class Habit(models.Model):
    ...
    is_pleasant = models.BooleanField(
        default=False, blank=True, null=True, verbose_name="Флаг приятности"
    )
    ...
    action = models.CharField(
        max_length=100, blank=True, null=True, verbose_name="Действие"
    )
    ...
    time_to_do = models.PositiveIntegerField(
        default=120, blank=True, null=True, verbose_name="Время на выполнение"
    )
    is_public = models.BooleanField(
        default=False, blank=True, null=True, verbose_name="Публичность"
    )
    send_indicator = models.PositiveIntegerField(
